<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MainAdmin.Master" AutoEventWireup="true" CodeBehind="ManagerRegister.aspx.cs" Inherits="RestaurantWebReservation.Presentation.AdminPage.ManagerRegister" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div>
    
    <table style="font-family: Verdana; font-size: 100%; background-color: #FFFFCC;" align="center" 
            bgcolor="#CCFFCC">
                <tr>
                    <td align="center" colspan="2" 
                        style="color: White; background-color: #800000; font-weight: bold;">
                        Register  New Manager</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="ConfirmPasswordLabel" runat="server" 
                            AssociatedControlID="ConfirmPassword">Password Confirm</asp:Label>
                    </td>
                    <td align="left">
